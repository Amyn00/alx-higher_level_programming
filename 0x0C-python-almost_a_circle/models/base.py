...
class Base:
    ...
    def draw(list_rectangles, list_squares):
        """Static method that draws all the Rectangles and Squares

        Args:
            list_rectangles (list): A list of Rectangle objs to draw.
            list_squares (list): A list of Square objs to draw
        """
        turt = turtle.Turtle()
